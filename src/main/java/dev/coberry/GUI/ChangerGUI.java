package dev.coberry.GUI;

import dev.coberry.Coberry;
import dev.coberry.Utils.APIUtils;
import dev.coberry.Utils.SessionChanger;
...
public class ChangerGUI extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 3100) {
            ...
            if (Objects.equals(Coberry.originalSession.getToken(), mc.getSession().getToken())) {
